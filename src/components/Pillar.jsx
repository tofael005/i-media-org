...
const Pillar = () => {
    return (
        <div className="mt-20 mb-20">
            ...
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-5 text-center gap-6 px-3">
                <div className='object-cover overflow-hidden border rounded-md'>
                    <Image className="hover:scale-105 scale-100 duration-500 h-[200px] object-cover w-full rounded-md p-3" src={kalima} alt=''></Image>
                    <Link href="/shahada"><h1 className="my-7 text-xl font-bold text-[#0B8998] uppercase">Shahadah</h1></Link>
                </div>
                <div className='object-cover overflow-hidden border rounded-md'>
                    <Image className="hover:scale-105 scale-100 duration-500 h-[200px] object-cover w-full rounded-md p-3" src={namaj} alt=''></Image>
                    <Link href="/salah"><h1 className="my-7 text-xl font-bold text-[#0B8998] uppercase">Salah</h1></Link>
                </div>
                <div className='object-cover overflow-hidden border rounded-md'>
                    <Image className="hover:scale-105 scale-100 duration-500 h-[200px] object-cover w-full rounded-md p-3" src={roja} alt=''></Image>
                    <Link href="/roja"><h1 className="my-7 text-xl font-bold text-[#0B8998] uppercase">Sawm</h1></Link>
                </div>
                <div className='object-cover overflow-hidden border rounded-md'>
                    <Image className="hover:scale-105 scale-100 duration-500 h-[200px] object-cover w-full rounded-md p-3" src={jakat} alt=''></Image>
                    <Link href="/zakat"><h1 className="my-7 text-xl font-bold text-[#0B8998] uppercase">Zakath</h1></Link>
                </div>
                <div className='object-cover overflow-hidden border rounded-md'>
                    <Image className="hover:scale-105 scale-100 duration-500 h-[200px] object-cover w-full rounded-md p-3" src={hajj} alt=''></Image>
