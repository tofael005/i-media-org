        ...
        <div className="max-w-[1240px] mx-auto my-14">
            ...
            <div className="flex gap-10 px-3">
                ...
                <div className='w-[840px]'>
                    ...
                    <div>
                        <div>
                            <Image className='w-full h-[500px]' src={blog}></Image>
                            <div className='flex gap-3 text-slate-500 font-light my-4'>
                ...
                <div className='w-[400px]'>
                    ...
                    <div className='mt-6 font-light'>
                        <Link href="/hajj"><h1 className='my-5 hover:font-semibold hover:text-[#0B8998] duration-300'>Hajj Guid (2)</h1></Link>
