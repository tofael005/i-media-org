...
const page = () => {
    return (
        <div className='max-w-[600px] mx-auto mt-6 mb-20 px-3 font-bangla'>
            ...
            <p>ওযুর মুস্তাহাব কি কি</p>
            <p>উঁচু স্থানে বসে ওযু করা।
                কিবলার দিকে মুখ করে ওযূ করা।
                দুনিয়াবি কথা না বলা।
                বিনা ওজরে কারো সাহায্য না নেওয়া।
                ডান হাত দিয়ে পানি নিয়ে কুলি করা।
                ডান হাত দিয়ে নাকে পানি দেওয়া ও বাম হাত দিয়ে নাক পরিষ্কার করা।
                নামাজের পূর্বেই ওযু করে প্রস্তুত থাকা।
                প্রত্যেক অঙ্গ ধোয়ার সময় বিসমিল্লাহ পাঠ করা।
                আংটি, নাক-ফুল, চুড়ি ঢিলা হয় তবে নাড়াচাড়া করে পানি পৌছানো। যদি ঢিলা না হয় তবে ভালভাবে নাড়াচাড়া করে অবশ্যই পানি পৌছাতে হবে।
                ওযু শেষে কিবলা মুখি হয়ে দাঁড়িয়ে কালিমায়ে শাহাদাত পাঠ করা।
                ওযু শেষে কিছু অবশিষ্ট পানি পান করা।</p>

            <p>ওযুর মাকরূহগুলো কি</p>
            <p>প্রয়োজনের তুলনায় কম বা বেশি পানি ব্যবহার করা।
                মুখের উপর জোরে পানি দেওয়া।
                ওযু করতে বসে দুনিয়াবি কথা বলা।
                প্রয়োজন ছাড়া কারো সাহায্য নেওয়া।
                নাপাক জায়গায় বসে ওযু করা।</p>

            <p>ওযুর দোয়া</p>
            <p>ওযুতে দোয়া পড়া উত্তম। এতে অনেক সাওয়াম রয়েছে। ozur dua ওযু করতে শুরুতে পড়তে হবে- ‘বিসমিল্লাহির রাহমানির রাহীম‘। এরপর ওযুর দোয়া- ‘বিসমিল্লাহিল আলিয়্যিল আজীম। ওয়াল হামদু লিল্লাহি আলা দ্বীনিল ইসলাম। আল ইসলামু হাককুন ওয়াল কুফরু বাতিলুন। আল ইসলামু নূরুন ওয়াল কুফরু জুলমাতুন‘। এছাড়া অযু শেষে আকাশের দিকে তাকিয়ে পড়তে হবে- ‘আশহাদু আল্লাইলাহা ইল্লাল্লাহু ওয়াহদাহু লা-শারীকালাহু ওয়াআশ হাদু আন্না মুহাম্মাদান আবদুহু ওয়া রাসূলুহু‘।</p>
            <p>এগুলো ছাড়াও ওযুর আরো অনেক দোয়া রয়েছে।</p>


            <p>ওযু কিভাবে করতে হয়</p>
            <p>ওযু করার নির্দিষ্ট নিয়ম কানুন রয়েছে। ozu korar sothik niom ওযু করতে হয় পানি দিয়ে। তাই প্রথমে পবিত্র পানি সংগ্রহ করতে হবে। এরপর নিচের নিয়মে ধারাবাহিকভাবে ওযূ করতে হবে-</p>
            <p>দুই হাতে পানি নিয়ে কব্জি পর্যন্ত ৩ বার ধৌত করতে হবে। এক হাতে আঙ্গুলকে অন্য হাতের আঙ্গুলের ভিতর ঢুকিয়ে খিলাল করতে হবে।
