    ...
    return (
        <div className='mt-16 bg-[#EBFAFA] mb-12 py-12'>
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 gap-5 px-3">
                <Image className="rounded-md w-full md:h-[550px] object-cover" src={about} alt=''></Image> 
                <div className="mt-6">
                    <p className="mb-5 text-[#0B8998]">About Us</p>
                    <h1 className="text-4xl font-bold mb-6 text-[#23306C]">Welcome to Islamic Media Organization Center for Muslims</h1>
